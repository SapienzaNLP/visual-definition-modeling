...
from src.modeling.vl_model_wrapper import get_vl_bert_pretrained_bart_model, get_lxmert_pretrained_bart_model
...
TEST_MAPPING={
        "word+img":["data/in/bert-bart-tokenized/test/word+img/"],
        "img+img": ["data/in/bert-bart-tokenized/test/img+img/"],
        }
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--decoder_tokenizer", required=True)
    ...
    else: raise RuntimeError(f'Cannot recognise base_model {base_model}.')
    ...
    dataset = FiniteFolderDataset(test_paths[0], name=task, shuffle=False,
            ...
            img_source=training_params.img_source)
